...
const Services = () => {
    return (
        <>
            ...
            <div id="process-3" className="pt-20 pb-0 process-section section-padding">
                <div className="container">
                    <div className="row">
                        <div className="col-xl-12 col-lg-12">
                            <div className="mt-40 row">
                                <div className="col-xl-5 col-lg-5 col-md-5 wow fadeInUp animated" data-wow-delay=".2s">
                                    <div className="section-title">
                                        <h6>Enjoy the Journey</h6>
                                        <h2>Your Development Process</h2>
                                        <p>
                                ...
                                <div className="col-xl-4 col-lg-4 col-md-4 wow fadeInUp animated" data-wow-delay=".2s">
                                    <div className="single-process-wrap">
                                        <div className="process-num">
                                            <span>01</span>
                                        </div>
                                        <h4>
                                            Let's start <br /> with hello_
                                        </h4>
                                        <p>
                                ...
                                <div className="col-xl-3 col-lg-3 col-md-3 wow fadeInUp animated" data-wow-delay=".4s">
                                    <div className="single-process-wrap">
                                        <div className="process-num">
                                            <span>02</span>
                                        </div>
                                        <h4>
                                            Paint <br /> your vision_
                                        </h4>
                                        <p>
                                ...
                                <div className="col-xl-4 col-lg-4 col-md-4 wow fadeInUp animated" data-wow-delay=".6s">
                                    <div className="single-process-wrap">
                                        <div className="process-num">
                                            <span>03</span>
                                        </div>
                                        <h4>
                                            The numbers <br /> game_
                                        </h4>
                                        <p>
                                ...
                                <div className="col-xl-4 col-lg-4 col-md-4 wow fadeInUp animated" data-wow-delay=".8s">
                                    <div className="single-process-wrap">
                                        <div className="process-num">
                                            <span>04</span>
                                        </div>
                                        <h4>
                                            Commit to <br /> the project_
                                        </h4>
                                        <p>
